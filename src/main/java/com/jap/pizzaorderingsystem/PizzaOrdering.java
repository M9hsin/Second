...
public class PizzaOrdering {
    ...
    public int displayPizzaChoicesAndCalculateTotalBill(int noOfPizza, int totalPizzaBill) {
        ...
        for (int i = 0; i < noOfPizza; i++) {
           ...
           // System.out.println("pizza1     > "+totalPizzaBill);
            ...
            int costOfCrust = 0;
            if(choiceOfCrust.equalsIgnoreCase("yes"))
            {
            	costOfCrust = displayCrustChoicesAndEstimatePrice(choiceOfCrust);
            }
            
          //  System.out.println("Crust1     >"+costOfCrust);
            ...
            if(choiceOfToppings.equalsIgnoreCase("yes"))
            {
            	costOfToppings=displayToppingsAndEstimatePrice(choiceOfToppings);
            	
            	
            }
            
          //  System.out.println("top1   >"+costOfToppings);
    ...
    public int calculateBillBasedOnPizzaChoiceAndSize(int totalPizzaBill, int pizzaChoice, String pizzaSize) {
       ...
       // return the cost calculated
    	int pizza[][]={{0,350,450},{0,300,400},{250,350,450},{200,300,400},{175,375,500}};
    	
    	if( (pizzaChoice>=1 && pizzaChoice<=5 ) && ( pizzaSize.equals("R") || pizzaSize.equals("L")  || pizzaSize.equals("M"))  )
    	{
    		int s=0;
        	...
        	//System.out.println("     >>>>> choice size "+(pizzaChoice-1)+" "+s);
        	//System.out.println("     >  "+pizza[pizzaChoice-1][s]);
        	
        	return totalPizzaBill + pizza[pizzaChoice-1][s];
    ...
    public int displayToppingsAndEstimatePrice(String choiceOfToppings) {
    	...
    	System.out.println("Enter the Toppings choice : ");
    ...
    public int calculateBillWithCrustAndToppings(int totalPizzaBill, int costOfCrust, int costOfToppings) {
    	...
    	if(costOfCrust>-1 && costOfToppings>-1)
    	{
    		return totalPizzaBill + costOfCrust + costOfToppings ;
    	}
    	else if(costOfCrust>-1)
    	{
    		return totalPizzaBill + costOfCrust;
    	}
    	else if(costOfToppings>-1)
    	{
    		return totalPizzaBill  + costOfToppings ;
    	}
    	else 
    	{
    		return totalPizzaBill;
    ...
    public int displayDrinksChoicesAndCalculateBill(int totalPizzaBill) {
       ...
       Scanner sc=new Scanner(System.in);
    	...
    	System.out.println("Enter your Bevarage Choice ");
    ...
    public int calculateFinalBillBasedOnDeliveryChargeAndTipCharge(int deliveryCharge, int tipCharge, int finalBill) {
    	...
    	if(tipCharge<0)
    	{
    		return finalBill + deliveryCharge;
    	}
